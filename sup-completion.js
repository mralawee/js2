...
var li19= $("#element_19").val();
 ...
 if (reasonsfordenial1 == 1) {
   var reason1;
            reason1 = "_-Scholar has successfully met the program objectives. ";
   reasons = reasons + reason1;
        }
 if (reasonsfordenial2 == 1) {
   var reason2;
            reason2 = "_-Scholar has NOT met the program objectives. ";
   reasons = reasons + reason2;
        } 
 if (reasonsfordenial3 == 1) {
  var reason3;
            reason3 = "_-Scholar is leaving the program earlier than anticipated. ";
   reasons = reasons + reason3;
        }
  if (reasonsfordenial4 == 1) {
  var reason4;
            reason4 = "_-Scholar has already terminated participation in the program. ";
   reasons = reasons + reason4 +;
        }
 if (reasonsfordenial5 == 1) {
  var reason5;
            reason5 = "_-Scholar maximized his/her stay as a J-1 scholar. ";
   reasons = reasons + reason5;
        }
if (reasonsfordenial6 == 1) {
  var reason6;
            reason6 = "_-Alternative nonimmigrant options to continue program participation were discussed with this scholar (i.e. Change of Status to H-1B or other visa). ";
