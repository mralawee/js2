...
var li2= $("#element_2").val();
 var li41= $("#element_41").val();
 var li43= $("#element_43").val();
 var li44= $("#element_44").val();
 var li42= $("#element_42").val();
 var li45= $("#element_45").val();
 
 var mm46=$("#element_46_1").val();
var dd46=$("#element_46_2").val();
var yy46=$("#element_46_3").val();
var li46=mm46+"/"+dd46+"/"+yy46;
 
 var li47= $("#element_47").val();
 var li48= $("#element_48").val();
 var li49= $("#element_49").val();
...
var querystring ="&element_32_1="+li32a+"&element_32_2="+li32b+"&element_29="+li29+"&element_33="+li33+"&element_2="+li2+"&element_38="+li11+"&element_39="+li7+"&element_40="+li4+"&element_35="+li35+"&element_6_1="+li6a+"&element_6_3="+li6c+"&element_6_4="+li6d+"&element_6_5="+li6e+"&element_6_6="+li6f+"&element_41="+li8+"&element_42="+li9+"&element_36="+li36+"&element_37="+li37+"&element_13="+li13+"&element_14="+li14+"&element_15="+li15+"&element_16="+li16+"&element_17="+li17+"&element_18="+li18+"&element_19="+li19+"&element_20="+li20+"&element_51="+li41+"&element_52="+li43+"&element_53="+li44+"&element_55="+li42+"&element_56="+li45+"&element_57="+li46+"&element_58="+li47+"&element_54="+li48+"&element_59="+li49;
querystring = querystring.replace(/\s/g,'%20');
var url = "https://okstate.forms-db.com/view.php?id=449205"+querystring;
$("#element_40").val(url);
});
});
